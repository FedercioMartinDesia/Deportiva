 ...
 * Sistema reorganizado: actividad (categoría) + modalidad (variante)
 */
...
export const MODALIDADES = {
  ...
  // Actividades sin modalidades (usan null)
  padel: [],
  basquet: [],
  natacion: [],
  gimnasio: [],
...
/**
 * Obtiene el label completo de una actividad + modalidad
 * @param {string} actividad - Actividad base
 * @param {string|null} modalidad - Modalidad (opcional)
...
/**
 * Obtiene la capacidad de participantes según actividad y modalidad
 * @param {string} actividad - Actividad base
 * @param {string|null} modalidad - Modalidad (opcional)
...
/**
 * Obtiene el icono de una actividad
 * @param {string} actividad - Actividad base
...
/**
 * Convierte formato antiguo de deporte a nuevo formato actividad + modalidad
 * Función legacy para compatibilidad con datos existentes
 * @param {string} deporteAntiguo - Formato antiguo (ej: 'FUTBOL_5')
 * @returns {object} { actividad, modalidad }
 */
